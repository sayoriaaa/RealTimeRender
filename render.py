...
#@SSAA
def pipline(width,height,save_path="results/res1.png",model_path=None,texture_name=None):
...
if __name__=="__main__":
    pipline(600,600,save_path="results/res15.png",model_path="model/box.obj",texture_name="model/box.png")
